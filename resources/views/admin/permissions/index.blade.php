@extends('layouts.app')
@section('content')
<div class="container-fluid" @if (app()->getLocale()=='ar') style="direction:rtl !important" @endif>
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="btn btn-success" href="{{ route("permissions.create") }}">
            {{ __('lang.add') }} {{ __('lang.permission.title_singular') }}
        </a>
    </div>
</div>
<div class="card">
    <div class="card-header">
        {{ __('cruds.permission.title_singular') }} {{ trans('global.list') }}
    </div>
