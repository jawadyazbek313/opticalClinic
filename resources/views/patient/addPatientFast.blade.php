                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old ('number') }}" class="form-control" name="number"
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card border-bottom-info shadow">
                    <div class="card-body justify-content-center text-center">
                        ...
                        <button class="btn btn-block btn-success" onclick="AddPatient()" type="button">{{__('lang.addPatient')}}</button>
                    </div>
