...
<div class="container-fluid">
    ...
    <div id="EyeDetail"  class="row  justify-content-center" style="display: none; margin-bottom: 75px">
        <div class="col-lg-12 col-md-12">
            <div class="card text-center {{ (app()->getlocale()=='ar') ? "border-right-success" : "border-left-success"}}">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OD_VA}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OD_BUT}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OD_IOP}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OD_AC}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OD_CD}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OS_VA}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OS_BUT}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OS_IOP}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OS_AC}}" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="{{$patient->OS_CD}}" type="text" class="form-control"
