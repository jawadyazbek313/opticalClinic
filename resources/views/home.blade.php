              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input minlength="4" disabled type="payment" value="{{old ('payment') }}" class="form-control"
                      name="payment" id="payment" placeholder="{{__('lang.inpPaymentPlaceHolder')}}" required>
...
<div @if (app()->getlocale()=='ar')
  style="direction:rtl"
  @endif class="modal fade " id="myModal1" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"
  style="display: none;">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <div class="row h-100 mt-4 rtl">
            <div class="col">
              <div class="form-group ">
                ...
                @error('notes')<div id="error" style="direction: ltr !important;" class="card text-white bg-danger">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      <label for="payment">{{__('lang.payment')}}</label>
                      <input disabled type="payment" value="{{old ('payment') }}" class="form-control" name="payment"
                        id="payment1" placeholder="{{__('lang.inpPaymentPlaceHolder')}}">
