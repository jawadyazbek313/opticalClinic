...
} elseif ($_instance->childHasBeenRendered('R9zqi87')) {
    $componentId = $_instance->getRenderedChildComponentId('R9zqi87');
    $componentTag = $_instance->getRenderedChildComponentTagName('R9zqi87');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('R9zqi87');
} else {
    $response = \Livewire\Livewire::mount('messages');
    $html = $response->html();
    $_instance->logRenderedChild('R9zqi87', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
