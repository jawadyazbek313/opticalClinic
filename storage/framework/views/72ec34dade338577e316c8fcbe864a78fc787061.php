...
<div class="container-fluid">
    <div class="row <?php if(app()->getlocale()=='ar'): ?>rtl <?php endif; ?>">
        <div class="col-lg-8 col-md-12 mb-4">
            <div
                class="card h-100 <?php echo e((app()->getlocale()=='ar') ? "border-right-primary" : "border-left-primary"); ?> justify-conternt-center text-center shadow-sm">
                <div class="card-header bg-light">
                    <?php echo e(__('lang.patientInfo')); ?> <a
                        class="btn btn-outline-success btn-sm <?php echo e((app()->getlocale()=='ar') ? "float-right" : "float-left"); ?>"
                        href="<?php echo e(route('patient.edit', $patient)); ?>"><i class="fa fa-pencil-alt"></i></a>
                </div>
                <div class="card-body">
                    <div class="row p-2">
                        <div class="col hoverbadges badge badge-primary border shadow-sm">
                            <h3 class="mt-2"><i
                                ...
                                <?php echo e($patient->firstname.' '.$patient->midname.' '.$patient->lastname); ?> </h3>
                        </div>
                    </div>
                    <div class="row p-2">
                        <div class="col-lg-4 col-md-6 hoverbadges badge badge-primary border shadow-sm">
                            <h3 class="mt-2"><i
                                ...
                                <?php echo e(($patient->gender=='male') ? __('lang.genderOptionMale') : __('lang.genderOptionFemale')); ?>
        ...
        <div class="col-lg-4 col-md-12 mb-4">
            ...
            <div
                class="card h-100 <?php echo e((app()->getlocale()=='ar') ? "border-right-success" : "border-left-success"); ?> justify-conternt-center text-center shadow-sm">
                <div class="card-header bg-light"><?php echo e(__('lang.Options')); ?></div>
                <div class="card-body">
                    <div class="row p-2">
                        <button class="showAppointments btn btn-lg btn-block btn-outline-success">
                            <i class="far fa-lg fa-calendar-alt"></i>&nbsp; <?php echo e(__('lang.ShowAppointments')); ?></button>
                    </div>
                    <div class="row p-2">
                        <button class="showPayments btn btn-lg btn-block btn-outline-success">
                            <i class="fas fa-lg fa-dollar-sign"></i>&nbsp; <?php echo e(__('lang.ShowPayments')); ?></button>
                    </div>
                    <div class="row p-2">
                        <button onclick="showEyeDetailFields()" id="btnToggleEyeDetails" class="showEyeDetails btn btn-lg btn-block btn-outline-success">
                            <i class="fas fa-lg fa-eye"></i>&nbsp; <?php echo e(__('lang.showMoreDetails')); ?></button>
                    </div>
    ...
    <div id="EyeDetail"  class="row  justify-content-center" style="display: none; margin-bottom: 75px">
        <div class="col-lg-12 col-md-12">
            <div class="card text-center <?php echo e((app()->getlocale()=='ar') ? "border-right-success" : "border-left-success"); ?>">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_VA); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_AUTO); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_BCVA_FAR); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_NEAR); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_AUTO_AFTER_CYCLO); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_BUT); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_IOP); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_LIDS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_CORNEA); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_CONJUNCTIVA); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_IRIS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_AC); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_LENS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_VITREOUS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_CD); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OD_FUNDUS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_VA); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_AUTO); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_BCVA_FAR); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_NEAR); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_AUTO_AFTER_CYCLO); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_BUT); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_IOP); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_LIDS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_CORNEA); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_CONJUNCTIVA); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_IRIS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_AC); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_LENS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_VITREOUS); ?>" type="text"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_CD); ?>" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?php echo e($patient->OS_FUNDUS); ?>" type="text"
...
function showEyeDetailFields() {
    ...
    if (x.style.display === "none") {
        y.innerText="<?php echo e(__('lang.hideDetails')); ?>";
      x.style.display = "block";
    } else {
        y.innerText="<?php echo __('lang.showMoreDetails'); ?>";
      x.style.display = "none";
    }
  }</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\opticalClinic\resources\views/patient/show.blade.php ENDPATH**/ ?>