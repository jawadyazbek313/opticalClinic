...
<div class="container-xl">
    <form autocomplete="off" action="<?php echo e(route('appointment.update', $appointment->id)); ?>" method="post">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
                                    <label for="patient_id">Patient (current: <a
                                            href="<?php echo e(route('patient.show', $appointment->patient[0]->id)); ?>">
                                            <?php echo e($appointment->patient[0]->firstname.' '.$appointment->patient[0]->midname.' '.$appointment->patient[0]->lastname); ?></a>)</label>
                            ...
                            <div class="col-lg-2 col-md-12">
                                <div style="direction: ltr !important" class="form-group">
                                    ...
                                    <input id="datepicker" value="<?php echo e($appointment->date); ?>" name="date" />
                                    <script>
                            ...
                            <div class="col-lg-2 col-md-12">
                                <div style="direction: ltr !important" class="form-group">
                                    ...
                                    <input id="timepicker" value="<?php echo e($appointment->time); ?>" name="time" />
                                    <script>
                                ...
                                <ul style="padding-right: 0 !important" class="list-group justify-content-center">
                                    <li class="list-group-item">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input <?php echo e(($appointment->isDone) ? 'checked' : ''); ?> class="form-check-input"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea rows="2" class="form-control" name="notes"
                                        placeholder="<?php echo e(__('lang.AppointmentNotesPlaceHolder')); ?>"><?php echo e($appointment->notes); ?><?php echo e(old ('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <span id="Payments" <?php echo e(($appointment->isDone) ? 'style=display:block;' : 'style=display:none;'); ?> ">
                        <hr>
                        <div class=" row">
                            <div class="col-lg-6 col-md-12">

                                <div class="form-group">
                                    <label for="payment_type"><?php echo e(__('lang.choosePaymentType')); ?> <?php if($appointment->isDone): ?>
                                        (current: <?php echo e($appointment->payment[0]->payment_type); ?>) <?php endif; ?></label>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="payment"
                                                value="<?php if($appointment->isDone): ?> <?php echo e($appointment->payment[0]->payment); ?> <?php endif; ?>"
                                                class="form-control" name="payment" <?php if(!($appointment->isDone)): ?> disabled <?php endif; ?> id="payment" 
                                                placeholder="<?php echo e(__('lang.inpPaymentPlaceHolder')); ?>">

                                        </div>
                                    </div>
                                    <div id="Currency" <?php if($appointment->isDone): ?>
                                        <?php echo e(($appointment->payment[0]->payment_type=='cash') ? 'style="display:block;"' : 'style=display:none;'); ?>

                                        <?php else: ?> 
                                        style="display:none;"
                                        <?php endif; ?>  class="col-4">
                                        <div class="form-group">
                                            <label for="payment_currency"><?php echo e(__('lang.choosePaymentCurrency')); ?>

                                                <?php if($appointment->isDone): ?>
                                                 <?php if($appointment->payment[0]->payment_type=='cash'): ?> <br> <?php if($appointment->payment[0]->payment_currency=='lbp'): ?> <?php echo e(__('lang.lbp')); ?> <?php else: ?>  <?php echo e(__('lang.us')); ?>) <?php endif; ?> <?php endif; ?> <?php endif; ?></label>
        ...
        <div class="card p-4 shadow pd-0 m-0 border-left-info">
            ...
            <div class="row ">
                ...
                <div class="col-3 border mx-0 pd-0 ">
                    <div class="row">
                        <div class="col no-padding"><input name="dist_r_sphere" value="<?php echo e($appointment->dist_r_sphere); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                    <div class="row">
                        <div class="col no-padding"><input name="dist_l_sphere" value="<?php echo e($appointment->dist_l_sphere); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                ...
                <div class="col-2 border ">
                    <div class="row">
                        <div class="col no-padding"><input name="dist_r_axis" value="<?php echo e($appointment->dist_r_axis); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                    <div class="row">
                        <div class="col no-padding"><input name="dist_l_axis" value="<?php echo e($appointment->dist_l_axis); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                </div>
            </div>
            <div class="row ">
                ...
                <div class="col-3 border mx-0 pd-0 ">
                    <div class="row">
                        <div class="col no-padding"><input name="near_r_sphere" value="<?php echo e($appointment->near_r_sphere); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                    <div class="row">
                        <div class="col no-padding"><input name="near_l_sphere" value="<?php echo e($appointment->near_l_sphere); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                ...
                <div class="col-2 border ">
                    <div class="row">
                        <div class="col no-padding"><input name="near_r_axis" value="<?php echo e($appointment->near_r_axis); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                    <div class="row">
                        <div class="col no-padding"><input name="near_l_axis" value="<?php echo e($appointment->near_l_axis); ?>"
                                class="form-control text-center" style="display: block; width:100%" type="text"></div>
                    </div>
                </div>
            </div>
            <div class="row border">
                ...
                <div class="col-7 no-padding"><input name="pddist" value="<?php echo e($appointment->pddist); ?>"
            ...
            <div class="row border">
                ...
                <div class="col-7 no-padding"><input name="pdnear" value="<?php echo e($appointment->pdnear); ?>"
                        class="form-control text-center" style="display: block; width:100%" type="text">
                </div>
                <div class="col-2">mm</div>
            </div>
            <br>
            <div class="row">
                <div class="col"><button class="btn btn-primary" type="submit"><?php echo e(__('lang.addAppointment')); ?></button>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\opticalClinic\resources\views/appointment/edit.blade.php ENDPATH**/ ?>