...
} elseif ($_instance->childHasBeenRendered('z0nAVs3')) {
    $componentId = $_instance->getRenderedChildComponentId('z0nAVs3');
    $componentTag = $_instance->getRenderedChildComponentTagName('z0nAVs3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('z0nAVs3');
} else {
    $response = \Livewire\Livewire::mount('messages');
    $html = $response->html();
    $_instance->logRenderedChild('z0nAVs3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input minlength="4" disabled type="payment" value="<?php echo e(old ('payment')); ?>" class="form-control"
                      name="payment" id="payment" placeholder="<?php echo e(__('lang.inpPaymentPlaceHolder')); ?>" required>
...
<div <?php if(app()->getlocale()=='ar'): ?>
  style="direction:rtl"
  <?php endif; ?> class="modal fade " id="myModal1" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"
  style="display: none;">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-12">
              <div class="form-group">
                ...
                <select id="patient_idjax" name="patient_id" class="selectpicker form-control justify-content-center"
              ...
              <ul style="padding-right: 0 !important" class="list-group justify-content-center">
                <li class="list-group-item">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="isDone" id="inlineRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1"><?php echo e(__('lang.yes')); ?></label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input checked class="form-check-input" type="radio" name="isDone" id="inlineRadio2" value="0">
...
$message = $__bag->first($__errorArgs[0]); ?><div id="error" style="direction: ltr !important;" class="card text-white bg-danger">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      <label for="payment"><?php echo e(__('lang.payment')); ?></label>
                      <input disabled type="payment" value="<?php echo e(old ('payment')); ?>" class="form-control" name="payment"
                        id="payment1" placeholder="<?php echo e(__('lang.inpPaymentPlaceHolder')); ?>">
...
$(".save-data").click(function(event){
  ...
  document.getElementById('payment_type1').addEventListener('change', function() {
    ...
    if(this.value!=null) x.disabled = false;
    if(this.value!='cash') {x.value=""; x.type='text'; if(document.getElementById('Currency1').style.display=="block") {document.getElementById('Currency1').style.display="none";}}
    else  {x.value=""; x.type='number'; document.getElementById('Currency1').style.display="block";}
});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\opticalClinic\resources\views/home.blade.php ENDPATH**/ ?>